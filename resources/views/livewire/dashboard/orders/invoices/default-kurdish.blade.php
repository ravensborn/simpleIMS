                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-transparent table-responsive">
                            ...
                            <tr>
                                ...
                                <th class="text-center" style="width: 1%">کۆی گشتی</th>
                                <th class="text-center" style="width: 1%">نر‌غ</th>
                                <th class="text-center" style="width: 1%">دانە</th>
                                <th class="text-end">کاڵا</th>
                            </tr>
                            </thead>
                            ...
                            <tr>
                                <td colspan="5" class="font-weight-bold text-uppercase text-end">
                                    ...
                                    &nbsp;
                                    &nbsp;
                                    <span class="fw-bold">${{ number_format($order->paid, 2) }}</span></td>
                            </tr>
                            <tr>
                                <td colspan="5" class="font-weight-bold text-uppercase text-end">
                                    بڕی ماوە
